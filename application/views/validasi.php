    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?= base_url('admin/master_data/tambah_validasi') ?>" enctype="multipart/form-data" method="post">
                        ...
                        <tbody>
                            <?php $no = 1; foreach ($get_data as $data) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <img class="popup-image" src="<?= base_url('uploads/Data_validasi/' . htmlspecialchars($data['jenis_daun']) . '/' . htmlspecialchars($data['nama_gambar'])); ?>" style="max-width: 100px; max-height: 200px;" alt="Gambar <?= htmlspecialchars($data['nama_gambar']); ?>">
                                    </td>
                                </tr>
                                ...
                                <div class="modal fade bd-example-modal-lg" id="modal-edit<?= htmlspecialchars($data['id_gambar']); ?>"
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            ...
                                            <form action="<?= base_url('admin/master_data/edit_validasi') ?>" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="modal fade bd-example-modal-lg" id="modal-hapus<?= htmlspecialchars($data['id_gambar']); ?>"
                                    ...
                                    <div class="modal-dialog ">
                                        <div class="modal-content">
                                            ...
                                            <form action="<?= base_url('admin/master_data/hapus_validasi') ?>" method="POST">
                                                <div class="modal-body">
                                                    <div class="basic-form">
                                                        <div class="mb-3 row">
                                                            <label class="col-sm-3 col-form-label">ID Gambar</label>
